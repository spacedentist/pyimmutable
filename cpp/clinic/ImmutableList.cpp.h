...
"--\n"
"\n"
"Return a copy extended by appending elements from the iterable.");
...
"index($self, value, start=0, stop=sys.maxsize - 1, /)\n"
"--\n"
"\n"
...
_pyimmutable_ImmutableList_index(pyimmutable::ImmutableList::Wrapper*self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    PyObject *value;
    Py_ssize_t start = 0;
    Py_ssize_t stop = PY_SSIZE_T_MAX - 1;
...
"\n"
"Raises IndexError if the index is outside the range of existing elements.");
...
/*[clinic end generated code: output=fab8a0dfe2f9d693 input=a9049054013a1b77]*/
